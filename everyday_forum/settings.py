"""
Django settings for everyday_forum project.
...
SECRET_KEY = 'django-insecure-o+=p(qp)-e!(m_jqat8((vm85fh8*(b_7l!m_@o=#lm$bq%@=@'
...
ROOT_URLCONF = 'everyday_forum.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main.context_processors.profile_picture',
            ],
        },
    },
]
